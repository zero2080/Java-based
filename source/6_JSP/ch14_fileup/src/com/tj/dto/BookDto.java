...
public class BookDto {
	...
	public String getBimage1() {return bimage1;}
	public void setBimage1(String bimage1) {this.bimage1 = bimage1;}
	public String getBimage2() {return bimage2;}
	public void setBimage2(String bimage2) {this.bimage2 = bimage2;}
	public String getBcontent() {return bcontent;}
	public void setBcontent(String bcontent) {this.bcontent = bcontent;}
	public int getBdiscount() {return bdiscount;}
	public void setBdiscount(int bdiscount) {this.bdiscount = bdiscount;}
	@Override
	public String toString() {
		return "BookDto [bid=" + bid + ", btitle=" + btitle + ", bprice=" + bprice + ", bimage1=" + bimage1
				+ ", bimage2=" + bimage2 + ", bcontent=" + bcontent + ", bdiscount=" + bdiscount + "]";
	}
}
