...
<body>
	...
	<div id="content">
		...
		<table>
			...
			<tr><td>우편번호</td><td>
			<input type="text" id="sample4_postcode" name="mpost" class="text_box"  placeholder="우편번호" onclick="sample4_execDaumPostcode()">
			...
			<tr><td>주소</td><td>
						...
						<input type="text" name="addDetail" id="addDetail" placeholder="상세주소">
						<!-- <span id="guide"></span> -->
				</td></tr>
			<tr><td colspan="2">
