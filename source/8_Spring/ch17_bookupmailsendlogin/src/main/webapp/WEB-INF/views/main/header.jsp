...
<header>
	...
	<c:if test="${not empty member}">
		<ul>
			<li><a href="${conPath }/member.do?method=modifyForm">정보수정</a></li>
	...
	<div class="lnb">
		<ul>
			<li><a href="${conPath}/main.do">홈</a>
			<li><a href="${conPath }/book.do?method=view&pageNum=1">도서보기</a></li>
			<li><a href="${conPath }/book.do?method=registerForm">도서등록</a>
			</li>
